...
public class DyTextViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dy_activity_text_view);
        ...
        textView = findViewById(R.id.__dy_text_view__);
        ...
        if (contents != null) {
            ...
            String text = JSONUtil.readFileToText(filePath);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        if (getIntent().getBooleanExtra(INTENT_KEY_OF_EDITABLE, false)) {
            ...
            item.setIcon(R.mipmap.wechat_icon_edit);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (itemId == __itemId_edit__) {
            ...
            if (title.equals("编辑")) {
                item.setIcon(R.mipmap.wechat_icon_save);
                item.setTitle("保存");
                setEditTextMode();
    ...
    private void setEditTextMode() {
        ...
        layoutParams.addRule(RelativeLayout.BELOW, R.id.__dy_toolbar_under_line__);
    ...
    private void saveTextEvent() {
        ...
        if (editText != null) {
            ...
            String filePath = getIntent().getStringExtra(INTENT_KEY_OF_FILEPATH);
            if (filePath != null) {
                JSONUtil.writeTextToFile(content, filePath);
            }
    ...
    public static void show(String title, String content, String filePath, boolean isEditable) {
        ...
        intent.putExtra(DyTextViewActivity.INTENT_KEY_OF_TITLE, title);
        intent.putExtra(DyTextViewActivity.INTENT_KEY_OF_CONTENTS, content);
        intent.putExtra(DyTextViewActivity.INTENT_KEY_OF_FILEPATH, filePath);
        intent.putExtra(DyTextViewActivity.INTENT_KEY_OF_EDITABLE, isEditable);
