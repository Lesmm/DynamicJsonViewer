...
public class DyDialogAlert {

    public static Context getTopActivity() {
        return DyRenderApi.getTopActivity();
    }
    ...
    public static String getTextInShowedEditTextDialog(DialogInterface dialogInterface) {
        Object mAlert = DyReflector.getFieldValue(dialogInterface, "mAlert");
        EditText mView = (EditText) DyReflector.getFieldValue(mAlert, "mView");
    ...
    public static class ProgressDialogEx extends ProgressDialog {
        ...
        public void setMessage(CharSequence message) {
            ...
            DyUtils.post(() -> superSetMessage(text));
        }
        ...
        public void setTitle(CharSequence title) {
            ...
            if (Looper.myLooper() == Looper.getMainLooper()) {
                ...
                DyUtils.post(() -> superSetTitle(text));
            }
        }
    ...
    public static DatePickerDialog showDatePicker(String title, final DatePickerDialogCallback datePickerDialogCallback) {
        ...
        DyUtils.post(mDatePickerDialog::show);

        if (title != null) {
            mDatePickerDialog.setTitle(title);  // set text first, then the mTitleView var is assigned
            DyUtils.post(() -> {
                Object mAlert = DyReflector.getFieldValue(mDatePickerDialog, "mAlert"); // AlertController
                TextView mTitleView = (TextView) DyReflector.getFieldValue(mAlert, "mTitleView"); // TextView
                if (mTitleView != null) {
