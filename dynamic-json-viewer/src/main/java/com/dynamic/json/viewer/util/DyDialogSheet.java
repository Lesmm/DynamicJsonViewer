...
public class DyDialogSheet {
    ...
    public DyDialogSheet(Context context) {
        this.context = context;
    }

    public DyDialogSheet builder() {
        View view = LayoutInflater.from(context).inflate(R.layout.dy_action_sheet_view, null);
        ...
        contentScrollView = (ScrollView) view.findViewById(R.id.dyActionSheetScrollView);
        contentLinearLayout = (LinearLayout) view.findViewById(R.id.dyActionSheetContentLayout);
        textViewTitle = (TextView) view.findViewById(R.id.dyActionSheetTitleText);
        textViewCancel = (TextView) view.findViewById(R.id.dyActionSheetCancelText);
    ...
    public DyDialogSheet setTitle(String title) {
    ...
    public DyDialogSheet setCancelable(boolean cancel) {
        dialog.setCancelable(cancel);
        return this;
    }

    public DyDialogSheet setCanceledOnTouchOutside(boolean cancel) {
        dialog.setCanceledOnTouchOutside(cancel);
        return this;
    }

    public DyDialogSheet addSheetItem(String strItem, Object object, int color, Drawable drawable, OnSheetItemClickListener listener) {
    ...
    private void setSheetItems() {
        ...
        for (int i = 1; i <= size; i++) {
            ...
            if (drawable != null) {
                ...
                textView.setBackgroundResource(R.drawable.dy_action_sheet_item_background);
            }
     ...
     * Static Methods
     */
    public static DyDialogSheet showActions(String title, String[] items, OnSheetItemClickListener listener) {
        return showActions(title, items, null, listener);
    }

    public static DyDialogSheet showActions(String title, String[] items, int[] colors, OnSheetItemClickListener listener) {
        return showActions(title, items, colors, null, listener);
    }

    public static DyDialogSheet showActions(String title, String[] items, int[] colors, Drawable[] drawables, OnSheetItemClickListener listener) {
        final DyDialogSheet dialog = new DyDialogSheet(DyRenderApi.getTopActivity());
        dialog.builder();
