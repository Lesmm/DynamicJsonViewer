...
public class DyPreferences {
    ...
    public DyPreferences(String fileName) {
        xmlFileName = fileName;
        isDefaultNotifyObserver = false;
    }

    public DyPreferences(String fileName, boolean isNotifyObserver) {
        xmlFileName = fileName;
    ...
    public void setValue(String key, Object value, boolean isNotifyObserver) {
        ...
        SharedPreferences.Editor editor = __SharedPreferences__().edit();
    ...
    public Object getValue(String key) {
        return __SharedPreferences__().getAll().get(key);
    }

    public Object getValue(String key, Object defValue) {
        Object value = __SharedPreferences__().getAll().get(key);
        return value == null ? defValue : value;
    }

    public SharedPreferences __SharedPreferences__() {
        return DyRenderApi.getApplication().getSharedPreferences(xmlFileName, Context.MODE_PRIVATE);
    }
     ...
     * Instances
     */
    public static DyPreferences Global = new DyPreferences(DyRenderApi.getPackageName() + "_preferences"); // [package_name]_preferences.xml
    public static DyPreferences User = new DyPreferences("user_preferences");          // user_preferences.xml
    public static DyPreferences Temp = new DyPreferences("temp_preferences");          // temp_preferences.xml

    private static DyPreferences instance = null;     // [package_name].xml

    public static DyPreferences getInstance() {
        if (instance == null) {
            instance = new DyPreferences(DyRenderApi.getPackageName(), true);
        }
        return instance;
    }
    ...
    public static void setWithFile(String fileName, String key, Object value) {
        DyPreferences preferences = (fileName != null && !fileName.isEmpty()) ? new DyPreferences(fileName) : getInstance();
