...
public class JSONTranslator {
    ...
    private static JSONTranslator __instance__ = null;

    public static JSONTranslator getInstance() {
        if (__instance__ == null) {
            __instance__ = new JSONTranslator();
        }
        return __instance__;
    }
    ...
    public void setMapValuesToObjectFields(Object object, Map<String, Object> map) {
        ...
        for (String name : map.keySet()) {
            Field field = DyReflector.searchField(clazz, name, 0, null);
            if (field == null) {
                continue;
            }
    ...
    public void setJsonValuesToObjectFields(Object object, JSONObject json) {
        ...
        while (keys.hasNext()) {
            ...
            Field field = DyReflector.searchField(clazz, name, 3, null);
            if (field == null) {
                continue;
            }
            ...
            if (value instanceof JSONObject) {
                ...
                if (value instanceof String && fieldType.isEnum() && fieldValue != null) {
                    ...
                    value = DyReflector.invokeMethod(enumClazz, "valueOf", new Class[]{String.class}, new Object[]{value.toString()});
                    ...
                    Object valueObj = DyReflector.parseValueOfNumber(fieldType, value);
                    if (valueObj != null && valueObj != value) {
                        value = valueObj;
                    }

                } else if (value instanceof String) {
                    Object valueObj = DyReflector.parseValueOfString(fieldType, value);
                    if (valueObj != null && valueObj != value) {
                        value = valueObj;
                    }
                }
    ...
    public void setJsonValuesToArrayField(Object array, JSONArray values) {
        ...
        Class<?> element_clazz = DyReflector.getElementClassForArray(array);
        ...
        for (int index = 0; index < len && values_len > index; index++) {
            ...
            if (element_clazz == char.class && value instanceof String) {
                ...
                DyReflector.setValueOfNumber(array, index, element_clazz, value);
        ...
        for (int i = 0; i < json.length(); i++) {
            ...
            if (element == null) {
                if (element_class == null) {
                    element_class = DyReflector.getFieldGenericElementType(field);
                }
                if (element_class != null) {
    ...
    public Object createInstanceForElement(Class<?> element_class, Object element_value, Object onObject, Field onField) {
        Object instance = DyReflector.newInstanceOf(element_class);
        if (instance == null && Parcelable.class.isAssignableFrom(element_class)) {
            try {
                Parcelable.Creator<?> CREATOR = (Parcelable.Creator<?>) DyReflector.getFieldValue(element_class, "CREATOR");
